...
write.table(results, file = "T:/_CogNeurPhD/03-Experiment_tDCS/resultsFrequencies.txt")

formattedresults = print(xtable(results), type="html")
write.table(formattedresults, file = "T:/_CogNeurPhD/03-Experiment_tDCS/resultsFrequencies.html")
